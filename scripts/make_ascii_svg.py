...
OUT = sys.argv[2] if len(sys.argv) > 2 else os.path.join(HERE, "..", "suyash-ascii.svg")
...
USER_HANDLE = os.environ.get("GH_PROFILE_USER", "SuyashSingh667")
FULL_NAME = os.environ.get("PROFILE_FULL_NAME", "Suyash Singh")
